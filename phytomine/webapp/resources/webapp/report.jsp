...
<div id="header_wrap">
  ...
  <div id="object_header">
    ...
    <div id="share">
      ...
      <script type="text/javascript">
        //<![CDATA[
        jQuery('#header_wrap #share a').click(function() {
          // show
          jQuery("#header_wrap #share div.popup").show();
          // select
          jQuery("#header_wrap #share div.popup").find('input').select();
        });
        jQuery('#header_wrap #share div.popup span.close').click(function() {
          // hide
          jQuery("#header_wrap #share div.popup").hide();
        });
        //]]>
      </script>
    </div><%-- #share --%>
