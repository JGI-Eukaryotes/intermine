...
import org.intermine.bio.dataconversion.ChadoDbDirectConverter;
import org.intermine.model.InterMineObject;
import org.intermine.model.bio.*;

/**
 * ChadoDbDirectConfig A class to encapsulate the chado details of
 ...
 *
 */
public class ChadoDbDirectConfig {
  ...
  static final HashMap<String,Class<? extends InterMineObject>> typeMap;
  static {
    typeMap = new HashMap<String, Class<? extends InterMineObject>>();
    typeMap.put("gene", (Class<? extends InterMineObject>) Gene.class);
    typeMap.put("mRNA", (Class<? extends InterMineObject>) MRNA.class);
    typeMap.put("exon", (Class<? extends InterMineObject>) Exon.class);
    typeMap.put("polypeptide", (Class<? extends InterMineObject>) Protein.class);
    typeMap.put("protein", (Class<? extends InterMineObject>) Protein.class);
    typeMap.put("five_prime_UTR", (Class<? extends InterMineObject>) FivePrimeUTR.class);
    typeMap.put("three_prime_UTR", (Class<? extends InterMineObject>) ThreePrimeUTR.class);
    typeMap.put("intron", (Class<? extends InterMineObject>) Intron.class);
    typeMap.put("CDS", (Class<? extends InterMineObject>) CDS.class);
  }
  static final HashMap<String,String> typeNameMap;
  static {
    ...
    typeNameMap.put("three_prime_UTR","ThreePrimeUTR");
    typeNameMap.put("intron","Intron");
    typeNameMap.put("CDS","CDS");
  }
  ...
  protected static final Logger LOG =
      Logger.getLogger(ChadoDbDirectConfig.class);
  ...
  public ChadoDbDirectConfig(Connection connection) {
  ...
  public static String referenceMethod(String a,String b) {
    return referenceMethod(new MultiKey(a,b));
  }
  public static String referenceMethod(MultiKey a) {
  ...
  public static Class<? extends InterMineObject> getIntermineType(String chadoType) throws BuildException {
  ...
  public static String getIntermineTypeName(String chadoType) throws BuildException {
    if (typeNameMap.containsKey(chadoType)) {
      return typeNameMap.get(chadoType);
    } else {
      throw new BuildException("Intermine type for "+chadoType+" is not set.");
    }
  }
