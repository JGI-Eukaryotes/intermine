        ...
        try {
          ...
          if (p1.equals(p2) && gene1.equals(gene2)) {
            ...
            try {
              ...
              o.proxyGene(getGene(pacGene1,p1));
              o.proxyOrtholog_gene(getGene(pacGene2,p2));
              o.proxyOrganism(orgProxys.get(Integer.parseInt(p1)));
              o.proxyOrtholog_organism(orgProxys.get(Integer.parseInt(p2)));
